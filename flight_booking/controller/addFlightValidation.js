console.log('Add Flight Validation script loaded');
const form = document.getElementById('addFlightForm');
if (form) {
    console.log('Form found');
    form.addEventListener('submit', function(event) {
        console.log('Add Flight Validation triggered');
        try {
            const errors = [];
            ...
            } else if (!/^[A-Z0-9]{2,20}$/.test(flightCode)) {
                errors.push('Flight code should be 2-20 uppercase letters and/or numbers (e.g., AA123, BA456).');
            }

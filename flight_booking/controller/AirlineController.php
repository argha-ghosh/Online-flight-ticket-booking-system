...
if (isset($_POST['submit'])) {
    ...
    $sql = "INSERT INTO airlines (airline_name, country_name, airline_code, airline_details, image) 
            VALUES ('$airline_name', '$country_name', '$airline_code', '$airline_details', '$image_path')";
...
if (isset($_GET['delete_id'])) {
    ...
    if ($conn->query($delete_sql) === TRUE) {
        header("Location: addAirline.php"); // Refresh the page after deletion
    } else {
...
if (isset($_POST['update'])) {
    ...
    if ($conn->query($update_sql) === TRUE) {
        ...
        header("Location: addAirline.php"); // Redirect back to the airline list page
    } else {
        echo "Error: " . $conn->error;
    }
}
